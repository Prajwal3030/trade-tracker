  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-16 max-w-6xl">
        <div className="text-center mb-20 animate-fade-in">
          ...
          <div className="flex items-center justify-center gap-5 mb-12">
            ...
            <div className="flex flex-col justify-center items-start">
              <h1 className="text-4xl font-bold bg-gradient-to-r from-slate-100 via-amber-200 to-amber-300 bg-clip-text text-transparent leading-tight">
                Tracer
              </h1>
          ...
          <h2 className="text-5xl md:text-7xl font-extrabold text-gray-100 mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
            ...
            <Link
              href="/journal"
              className="group inline-flex justify-center items-center gap-3 px-10 py-5 rounded-2xl bg-[#1f2937] text-gray-200 font-semibold hover:bg-[#374151] transition-all duration-300 shadow-xl border border-gray-700/50 hover:border-amber-400/30 hover:shadow-amber-400/10"
            >
        ...
        {/* Use Case Section */}
        <div className="relative bg-gradient-to-br from-[#1f2937] via-[#1a1f2e] to-[#111827] rounded-3xl p-10 md:p-14 border border-gray-700/50 mb-20 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-amber-400/5 via-transparent to-emerald-400/5"></div>
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-10">
              <div className="w-2 h-10 bg-gradient-to-b from-amber-400 to-yellow-500 rounded-full"></div>
              <h2 className="text-4xl font-bold text-gray-100">Perfect For Multi-Timeframe Traders</h2>
            </div>
        ...
        <div className="text-center relative">
          <div className="relative inline-block bg-gradient-to-br from-[#1f2937] to-[#111827] rounded-3xl p-12 border border-gray-700/50 shadow-2xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-amber-400/10 via-transparent to-yellow-400/10"></div>
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-amber-400/10 mb-6">
